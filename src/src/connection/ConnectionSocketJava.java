...
public class ConnectionSocketJava {
    // initialize socket and input output streams 
    private Socket socket              = null; 
    private DataInputStream  input     = null; 
    private DataOutputStream output    = null;
    private static ConnectionSocketJava cs = null;
    
    private ConnectionSocketJava() {
    	
    }
    
    public static ConnectionSocketJava getInstance() {
    	if (cs == null) {
    		cs = new ConnectionSocketJava();
    		cs.connectToRPI();
    	}
    	return cs;
    }
